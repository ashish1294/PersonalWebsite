...
(12, 'RDBMS Graph Storage', 'Graph Based Data Storage (RDBMS)', 'model.png', 'Major components of the Graph Based Storage Engine', 'graph_storage_rdbms', 'course', 'RDBMS Graph Storage', 'https://github.com/Bug-Assassins/Relational-Graph-Database', 1),
